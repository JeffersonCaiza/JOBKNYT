                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            <label for="NOMBRES"
                                                   class="col-md-4 col-form-label text-md-right"><strong>Nombres</strong></label>
                                            <div class="col-md-6">
                                                <input v-model="estudiante.IDHOJA.NOMBRESC" type="label" class="form-control"
                                                       id="NOMBRES"
                                                       placeholder="Nombres">
                                                       <span class="text-danger"
                                                      v-if="errores.NOMBRES">{{ errores.NOMBRES[0] }}</span>
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input disabled v-model="estudiante.IDHOJA.TITULOUNIVERSIDAD" type="label" class="form-control"
                                                       id="TITULOUNIVERSIDAD" placeholder="">
                                                       <span class="text-danger"
...
export default {
    ...
    methods: {
        list() {
            axios.get(`lista_postulacioneses`).then(res => {
                this.est = res.data;
      ...
      //});
        ...
        async save() {
            try {
                if (this.update) {
                    const res = await axios.put('postulaciones/' + this.id, this.estudiante);
                } else {
                    const res = await axios.post('postulaciones', this.estudiante);
                }
                this.closeModal();
                this.list();
